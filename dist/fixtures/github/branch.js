...
exports.getBranchPayload = void 0;
const user_1 = require("./user");
function getBranchPayload(params) {
    return {
        name: params.name,
        commit: {
            sha: params.commit,
            ...
            commit: {
                author: (0, user_1.getGitUserPayload)({ login: params.name, email: `${params.name}@example.com` }),
                committer: (0, user_1.getGitUserPayload)({ login: params.name, email: `${params.name}@example.com` }),
                message: "update",
                tree: {
            ...
            author: (0, user_1.getUserPayload)({ id: 77391175, login: params.author }),
            committer: (0, user_1.getUserPayload)({ id: 77391175, login: params.author }),
            parents: [
                {
...
exports.getBranchPayload = getBranchPayload;
